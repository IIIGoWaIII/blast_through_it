...
**Blast Through It** is a high-speed RSVP (Rapid Serial Visual Presentation) reader designed to help you consume information faster. Built with React and powered by Vite, it provides a seamless and customizable reading experience.
...
- **File Parsing**:
    - [Mammoth.js](https://github.com/mwilliamson/mammoth.js) (DOCX)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/IIIGoWaIII/blast_through_it.git
   cd blast_through_it
   ```
